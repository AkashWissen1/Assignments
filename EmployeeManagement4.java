        ...
        while (mainFlag) {
            ...
            try {
                ...
                if (choice < 1 || choice > 5) {
                    throw new EmployeeManagementException("Invalid menu choice, please retry.");
                }
            } catch (InputMismatchException e) {
                System.out.println("Error: Provide a valid integer input.");
                sc.nextLine();
                continue;
        ...
        while (true) {
            ...
            try {
                ...
                if (choice < 1 || choice > 4) {
                    throw new EmployeeManagementException("Invalid role choice! Please select between 1 and 3.");
                }
                if (choice == 4) {
                    return;
                }
            } catch (InputMismatchException e) {
                System.out.println("Error: Please enter a valid number for role choice.");
                sc.nextLine();
                continue;
            } catch (EmployeeManagementException e) {
                System.out.println(e.getMessage());
            ...
            try {
                ...
                age = sc.nextInt();
                if (age < 21 || age > 60) {
                    throw new EmployeeManagementException("Invalid age! Age should be between 21 and 60.");
                }
            } catch (InputMismatchException e) {
